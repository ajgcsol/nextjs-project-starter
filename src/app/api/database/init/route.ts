...
export async function GET(request: NextRequest) {
  try {
    console.log('Initializing database schema via GET...');
    ...
    console.log('Database schema initialized successfully via GET');
    ...
    return NextResponse.json({
      ...
      note: 'Database is ready for video uploads!'
    });
  ...
  try {
    ...
    await query(`
      ...
      (
        ...
        '00000000-0000-0000-0000-000000000001',
        'Contract Law',
        ARRAY['contracts', 'formation', 'considerations'],
        'public',
        'ready',
        'contract-formation.mp4',
        'sample-2_original.mp4',
