...
export class AWSTranscribeService {
  ...
  constructor() {
    ...
    try {
      ...
      console.error('❌ Failed to create AWS Transcribe client:', error);
      throw new Error(`AWS Transcribe client initialization failed: ${error instanceof Error ? error.message : 'Unknown error'}`);
    }
  }
